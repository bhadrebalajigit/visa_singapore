	...
	public void correct_username_inValidate_password() throws IOException
	{
	 ...
	 public void TearDown(ITestResult result) throws IOException{
	  ...
	  if (result.getStatus() == ITestResult.FAILURE || result.getStatus() == ITestResult.SUCCESS ){
	   ...
	   FileUtils.copyFile(srcFile, new File("E://Visa_Singapore_project//com.visa.qa//src//test//java//com//amazon//qa//Screenshots//Negative//"+result.getName()+"_"+new SimpleDateFormat("yyyyMMdd_HHmmss").format(new Date())+".jpg"));
